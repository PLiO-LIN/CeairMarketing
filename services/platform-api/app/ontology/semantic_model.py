...
SEMANTIC_MODEL_VERSION = "ceair-marketing-ontology-v1.0"
...
RELATION_TYPES = [
    ...
    {"id": "targets_audience", "name": "面向客群", "from_types": ["Opportunity", "Campaign", "MarketingCase", "ProductPackage"], "to_types": ["AudienceSnapshot", "CustomerAggregate"]},
    {"id": "uses_product_package", "name": "使用产品包", "from_types": ["Campaign", "MarketingCase", "AudienceSnapshot"], "to_types": ["ProductPackage"]},
    {"id": "contains_product", "name": "包含产品", "from_types": ["ProductPackage"], "to_types": ["Product"]},
    {"id": "addresses_opportunity", "name": "响应机会", "from_types": ["Campaign", "MarketingCase", "ProductPackage"], "to_types": ["Opportunity"]},
    ...
    {"id": "uses_channel", "name": "使用渠道", "from_types": ["ExecutionBatch", "CampaignVersion"], "to_types": ["Channel"]},
    {"id": "produces_feedback", "name": "产生反馈", "from_types": ["ExecutionBatch", "Campaign"], "to_types": ["Feedback"]},
    {"id": "reviewed_by", "name": "由复盘形成", "from_types": ["Campaign", "MarketingCase"], "to_types": ["Review"]},
